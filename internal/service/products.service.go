...
import (
	...
	models "github.com/darwinuzcategui1973/qrtomfoto-produ/internal/models"
)
...
func (s *serv) AddProdcut(ctx context.Context, product models.Product, name string) error {
